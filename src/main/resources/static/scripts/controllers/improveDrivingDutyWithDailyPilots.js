...
angular.module('crewLinkApp').controller(
		'ImproveDrivingDutyWithDailyPilotsCtrl',
		function($scope, $position, $http, $confirm, $resource,
			...
			$scope.callDataFetch = function(runDays){
				
				$http.get('/api/custom/improvementSuggestions/drivingDutyWithDailyPilots?minRunDays='+runDays
