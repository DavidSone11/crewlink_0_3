...
angular.module('crewLinkApp').controller(
		...
		function($scope, $position, $http, $confirm, $resource,
			...
			$scope.callDataFetch = function(){
				
				$http.get('/api/custom/crewLinks/stationSummary?userPlan='+UserService.getSelectedUserPlan().id).then(function(res){
